 ...
 * @property {Array.OverlayView|Array.object} [geometries] Array of <code>google.maps.LatLng, Polyline, Polygon</code>, or ESRI Geometry format to project.
  ...
  */
  ...
  function MapOverlay(service, opt_overlayOpts) {
    ...
    this.needsNewRefresh_ = true;																	//Changed to true by JKIRKLAN on 1/25/17 to make sure layers with layerids are refreshed when first created so they don't initially show all layers
    this.overlay_ = null;
    this.div_ = null;

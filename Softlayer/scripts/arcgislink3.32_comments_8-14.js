...
MapOverlay.prototype.checkDraw = function (fWidth, fHeight, fBounds, fBoundsSW, fBoundsNE, fBoundsSW_lng, fBoundsNE_lng, calledFrom) {
	...
	// Check current first
	var returnVal_current = this.checkBounds(fWidth, fHeight, fBoundsSW_lng, fBoundsNE_lng, 'current');
	...
	// Check last next
	var returnVal_last = this.checkBounds(fWidth, fHeight, fBoundsSW_lng, fBoundsNE_lng, 'last');
...
MapOverlay.prototype.checkBounds = function (fWidth, fHeight, fBoundsSW_lng, fBoundsNE_lng, checkAgainst) {
	var returnVal = {
		needsDraw: false,
		msg: '',
		compared: false,
  ...
  */
  ...
  this.mapService_.exportMap(fParams, function (json) {
      /* [QUESTION] How early should _drawing be set to false? Should it do anything? - CLarson 8/13/18 */
		...
		var returnVal_current = self.checkBounds(fWidth, fHeight, fBoundsSW_lng, fBoundsNE_lng, 'current');
		if(!returnVal_current.compared){
		...
		// Check against current once response is received
		returnVal_current = self.checkBounds(fWidth, fHeight, fBoundsSW_lng, fBoundsNE_lng, 'current');
		if(!returnVal_current.compared){
